...
# 데이터 추가
def add_supplements_nutrient(name, unit, details):
    sql = "INSERT INTO supplements_nutrient (name, unit, details) VALUES (?, ?, ?)"
    cursor.execute(sql, (name, unit, details))
    conn.commit()

# 데이터 추가 예시
add_supplements_nutrient("열량", "kcal", ".")
add_supplements_nutrient("단백질", "g", ".")
add_supplements_nutrient("식이섬유", "g", ".")
add_supplements_nutrient("수분", "g", ".")
add_supplements_nutrient("비타민A", "µgRE", ".")
add_supplements_nutrient("비타민D", "µg", ".")
add_supplements_nutrient("비타민E", "mg α-TE", ".")
add_supplements_nutrient("비타민K", "µg", ".")
add_supplements_nutrient("비타민C", "mg", ".")
add_supplements_nutrient("티아민", "mg", ".")
add_supplements_nutrient("리보플라민", "mg", ".")
add_supplements_nutrient("나이아신", "mg NE", ".")
add_supplements_nutrient("비타민B6", "mg", ".")
add_supplements_nutrient("엽산", "µg", ".")
add_supplements_nutrient("비타민B12", "µg", ".")
add_supplements_nutrient("판토텐산", "mg", ".")
add_supplements_nutrient("비오틴", "mg", ".")
add_supplements_nutrient("칼슘", "mg", ".")
add_supplements_nutrient("인", "mg", ".")
add_supplements_nutrient("나트륨", "g", ".")
add_supplements_nutrient("염소", "g", ".")
add_supplements_nutrient("칼륨", "g", ".")
add_supplements_nutrient("마그네슘", "mg", ".")
add_supplements_nutrient("철", "mg", ".")
add_supplements_nutrient("아연", "mg", ".")
add_supplements_nutrient("구리", "µg", ".")
add_supplements_nutrient("불소", "mg", ".")
add_supplements_nutrient("망간", "mg", ".")
add_supplements_nutrient("요오드", "µg", ".")
add_supplements_nutrient("셀레늄", "µg", ".")
add_supplements_nutrient("몰데브덴", "mg", ".")
add_supplements_nutrient("스테로이드", ".", ".")
add_supplements_nutrient("프레드니솔론", ".", ".")
add_supplements_nutrient("베타카로틴", "mg", ".")
add_supplements_nutrient("제니칼", "mg", ".")
add_supplements_nutrient("콜레스티라민", "g", ".")
add_supplements_nutrient("페노바르비탈", ".", ".")
add_supplements_nutrient("페니토인", ".", ".")
add_supplements_nutrient("푸로세미드", "mg", ".")
add_supplements_nutrient("플루오로우라실", "mg", ".")
add_supplements_nutrient("발프론산", "mg", ".")
add_supplements_nutrient("카바마제핀", "mg", ".")
add_supplements_nutrient("사이클로세린", "mg", ".")
add_supplements_nutrient("클로람페니콜", "g", ".")
add_supplements_nutrient("메트포르민", "mg", ".")
add_supplements_nutrient("클로렐라", "g", ".")
add_supplements_nutrient("스피루리나", "g", ".")
add_supplements_nutrient("비타민B1", "mg", ".")
