...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='intake',
            field=models.ManyToManyField(through='user.UserIntake', to='supplements.nutrient'),
        ),
        migrations.AddField(
            model_name='user',
            name='recommended',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='supplements.recommendedintake'),
        ),
        migrations.AddField(
            model_name='user',
